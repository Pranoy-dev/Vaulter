...
export const Thread: FC<{ chatPrepend?: ReactNode; disabled?: boolean }> = ({ chatPrepend, disabled }) => {
  return (
    ...
    >
      ...
      >
        {chatPrepend ? (
          <div className="aui-thread-chat-prepend shrink-0 border-b border-white/10 pb-3">
            {chatPrepend}
          </div>
        ) : null}
        {!disabled && (
  ...
  return (
    <ThreadPrimitive.ScrollToBottom asChild>
      <TooltipIconButton
        ...
        variant="outline"
        className="aui-thread-scroll-to-bottom absolute -top-12 z-10 self-center rounded-full p-4 disabled:invisible dark:border-white/12 dark:bg-muted dark:hover:bg-muted/85"
      >
        <ArrowDownIcon />
      </TooltipIconButton>
